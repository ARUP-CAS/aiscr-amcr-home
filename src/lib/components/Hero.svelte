...
<section class="hero-section px-4 sm:px-6 lg:px-8" style="height: 780px; margin-top: 170px; display: flex; align-items: center;">
  <div class="max-w-content w-full">
    <div class="hero-content text-left">
      ...
      <p class="hero-subtitle" style="font-family: 'Roboto', sans-serif; font-size: 24px; font-weight: 700; color: #000000; margin-bottom: 24px; text-align: left;">
        {m['hero.subtitle']()}
      </p>
